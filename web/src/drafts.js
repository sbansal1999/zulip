...
function update_bulk_delete_ui() {
    ...
    if ($checked_checkboxes.length > 0) {
        $(".delete-selected-drafts-button").prop("disabled", false);
        if ($unchecked_checkboxes.length === 0) {
            $(".select-drafts-button .select-state-indicator").prop("checked", true);
        } else {
            $(".select-drafts-button .select-state-indicator").prop("checked", false);
        }
    } else {
        if ($unchecked_checkboxes.length > 0) {
            $(".delete-selected-drafts-button").prop("disabled", true);
            $(".select-drafts-button .select-state-indicator").prop("checked", false);
        } else {
            $(".delete-selected-drafts-button").hide();
