...
class GitHubWebhookTest(WebhookTestCase):
    ...
    def test_issue_milestoned(self) -> None:
        ...
        expected_message = "[sbansal1999](https://github.com/sbansal1999) added the [some_random_milestone](https://github.com/sbansal1999/testing-gh/milestone/1) milestone to [issue #6](https://github.com/sbansal1999/testing-gh/issues/6)."
    ...
    def test_issue_milestoned_with_custom_topic_in_url(self) -> None:
        self.url = self.build_webhook_url(topic="notifications")
        expected_topic = "notifications"
        expected_message = "[sbansal1999](https://github.com/sbansal1999) added the [some_random_milestone](https://github.com/sbansal1999/testing-gh/milestone/1) milestone to [issue #6 This is a sample issue to test GH Integration Func](https://github.com/sbansal1999/testing-gh/issues/6)."

        self.check_webhook("issues__milestoned", expected_topic, expected_message)

    def test_issue_demilestoned(self) -> None:
        expected_topic = "testing-gh / issue #6 This is a sample issue to test GH I..."
        expected_message = "[sbansal1999](https://github.com/sbansal1999) removed the [some_random_milestone](https://github.com/sbansal1999/testing-gh/milestone/1) milestone from [issue #6](https://github.com/sbansal1999/testing-gh/issues/6)."
